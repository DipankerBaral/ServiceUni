...
const backgroundImageUrl =
  "https://live-production.wcms.abc-cdn.net.au/07de6b31c4f08d58e715ecc7837f0db6?impolicy=wcms_crop_resize&cropH=1080&cropW=1920&xPos=0&yPos=100&width=862&height=485";
const Register = () => {
  ...
  const roles = ["student", "admin"]; // Define the available roles
